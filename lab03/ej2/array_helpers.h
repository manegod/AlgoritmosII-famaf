...
#define FST_YEAR 1980 //first recorded year
#define LST_YEAR 2016 //last recorded year
#define YEARS 37      //ammount of years recorded

typedef enum {january, 
              february, 
              march, 
              april, 
              may, 
...
#define FST_DAY 1  //first day of the month
#define LST_DAY 28 //last day of the month
#define DAYS 28    //ammount of days
